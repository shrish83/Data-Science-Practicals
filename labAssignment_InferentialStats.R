...
zsc <- (100*(((40*30)-(10*20)) ** 2))/(60*40*50*50)
zsc
#Since the significant value of z=1.96
#Also: z>3, Simply reject
#and zsc >  z i.e 16.67 > 1.96
#Inference: :Since the calculated value of z is too large than
# the sigificant value, The null hypothesis is rejected.
